...
function Nearevent_card(prop) {
    var id = prop.id, src = prop.src, src1 = prop.src1, src2 = prop.src2, title1 = prop.title1, title2 = prop.title2, title3 = prop.title3;
    return (react_1["default"].createElement("div", { className: "grid__item" },
        ...
        react_1["default"].createElement("div", { className: "grid2" },
            ...
            react_1["default"].createElement("div", { className: "parent" },
                react_1["default"].createElement("img", { className: "img2", src: src1, alt: "" }),
                react_1["default"].createElement("img", { className: "img1", src: src2, alt: "" })))));
}
