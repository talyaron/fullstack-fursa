...
//import { ProductProps } from "./view/pages/product/product";
...
function App() {
  ...
  const cosmetics: Array<ProductInt>  = [{ id: 1, name: 'Organic-Cosmetics', img: 'https://static.manna.global/img/cms/uk/980/5170-how-much-do-you-know-about-natural-cosmetics-152004.png',text:"" },
  ...
  const cupping:TreatmentInt = { id: 1, name: 'Cupping Therapy', img: 'https://media.wsimag.com/attachments/193b9b637c3a7dfcb27b91a14ed0d47878d88ca1/store/fill/1090/613/4621d5afb058b57330ba40e4d8ba23534743e5c727f3e6d06d5eceda4452/Cupping-therapy.jpg',
  ...
  const facial:TreatmentInt = { id: 1, name: 'Facial Treatment', img: 'https://5.imimg.com/data5/VW/YX/GLADMIN-63916043/herbal-face-clean-up-treatment-500x500.png',
  ...
  const candles:TreatmentInt = { id: 1, name: 'Hopi Ear Candles', img: 'https://saltandcrystal.com/wp-content/uploads/2019/03/viber-image-3_E.jpg',
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="cosmetics" element={<Cosmetics />}>
          <Route path=":productId" element={<Product products={cosmetics} />} />
        </Route>
