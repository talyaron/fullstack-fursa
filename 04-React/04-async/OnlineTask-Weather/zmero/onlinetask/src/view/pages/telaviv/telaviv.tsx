...
function TelAviv() {
    ...
    function getData() {
        return new Promise((resolve, reject) => {
            fetch(`http://api.weatherapi.com/v1/current.json?key=91901e4c18864d49872135614221502&q=Tel Aviv&aqi=no`)
        ...
        <div className="main">
            ...
            <div className="background">
                <div className="badget">
                    ...
                    <div className="temp">{telaviv}<sup>°C</sup></div>
                </div>
            </div>
        </div>
    )
