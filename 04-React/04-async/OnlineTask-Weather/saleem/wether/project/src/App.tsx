...
function App() {
  ...
  function findCity() {
    return new Promise((resolve, reject) => {
      fetch(
        `http://api.openweathermap.org/data/2.5/weather?q=${search}&units=metric&appid=4ebb9418ca605fa1931880e565ec065c`
      )
  ...
  return (
    <div className="box">
      <div className="InputData">
        ...
        />
        <input value="Submit" type="button" className="btn" onClick={setData} />
        ...
        {!city ? (
          ...
          <div>
            <h1 className="temp">curernt temp {temp}</h1>
